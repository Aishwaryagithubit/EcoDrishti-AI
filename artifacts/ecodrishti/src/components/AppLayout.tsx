...
const navItems = [
  { path: '/dashboard', icon: LayoutDashboard, labelKey: 'nav.dashboard', label: 'Dashboard', labelNp: 'ड्यासबोर्ड' },
  { path: '/carbon-calculator', icon: Calculator, labelKey: 'nav.calculator', label: 'Calculator', labelNp: 'क्याल्कुलेटर' },
  { path: '/reports', icon: FileText, labelKey: 'nav.reports', label: 'Reports', labelNp: 'रिपोर्टहरू' },
  { path: '/community', icon: Users, labelKey: 'nav.community', label: 'Community', labelNp: 'समुदाय' },
  { path: '/challenges', icon: Zap, labelKey: 'nav.challenges', label: 'Challenges', labelNp: 'चुनौतीहरू' },
  { path: '/league', icon: Trophy, labelKey: 'nav.league', label: 'Eco League', labelNp: 'इको लिग' },
];
